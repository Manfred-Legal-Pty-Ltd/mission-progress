window.DASHBOARD_DATA = {
  ...
  kpis: [
    ...
    { key: "blockers", label: "Blockers", value: "0", subLabel: "None open", detail: "The release dependency that was open has cleared: the company-side GitHub billing item is resolved. The next update has now passed its full verification and is being published. It is not yet confirmed live; once it is, it reaches the firm through the usual automatic update." },
  ...
  dailyLog: [
    { date: "11 September 2026", items: [
      "The company-side GitHub billing item cleared, resolving the dependency that was holding delivery of the next update. That update has now passed its full verification and is being published. It is not yet confirmed live; once it is, it reaches the firm through the usual automatic update, with nothing to install by hand.",
