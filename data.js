window.DASHBOARD_DATA = {
  ...
  kpis: [
    ...
    { key: "blockers", label: "Blockers", value: "0", subLabel: "None open", detail: "The release dependency that was open has cleared: the company-side GitHub billing item is resolved. v0.1.34 has been released and verified. It reaches the firm through the usual automatic update: Gideon detects it, downloads it in the background, and prompts a restart to move to the new version." },
